...
public class AddMemberUniversal implements ICommand {
    ...
    public AddMemberUniversal(CubitBukkitPlugin plugin, String permNode, CubitType type, boolean isAdmin) {
        this.plugin = plugin;
    ...
    public boolean runCmd(final Command cmd, final CommandSender sender, String[] args) {
        ...
        UUID uuid = offlinePlayer.getUniqueId();
        if (!plugin.getRegionManager().addMember(cubitLand, loc.getWorld(), uuid)) {
            /* If this task failed! This should never happen */
