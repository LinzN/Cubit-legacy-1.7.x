...
import de.kekshaus.cubit.land.commandSuite.landCommands.main.KickLand;
...
import de.kekshaus.cubit.land.commandSuite.landCommands.main.TakeOfferLand;
...
public class CommandLand implements CommandExecutor {
	...
	public void loadCmd() {
		try {
			...
			this.cmdMap.put("kick", new KickLand(this.plugin, perm.kickLand));
