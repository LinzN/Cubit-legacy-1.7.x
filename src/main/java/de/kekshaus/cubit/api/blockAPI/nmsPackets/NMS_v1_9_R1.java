...
public class NMS_v1_9_R1 implements INMSMask {
	...
	@Override
	  ...
	  {
		org.bukkit.craftbukkit.v1_9_R1.CraftWorld localCraftWorld = (org.bukkit.craftbukkit.v1_9_R1.CraftWorld)paramWorld;
	    net.minecraft.server.v1_9_R1.WorldServer localWorldServer = localCraftWorld.getHandle();
	    
	    int[] arrayOfInt = LocationUtil.translateChunkXZ(paramInt1, paramInt3);
	    net.minecraft.server.v1_9_R1.Chunk localChunk = localWorldServer.getChunkAt(arrayOfInt[0], arrayOfInt[1]);
	    
	    net.minecraft.server.v1_9_R1.BlockPosition localBlockPosition = new net.minecraft.server.v1_9_R1.BlockPosition(paramInt1, paramInt2, paramInt3);
	    net.minecraft.server.v1_9_R1.IBlockData localIBlockData = net.minecraft.server.v1_9_R1.Block.getByCombinedId(BlockUtil.getCombinedID(paramInt4, paramByte));
