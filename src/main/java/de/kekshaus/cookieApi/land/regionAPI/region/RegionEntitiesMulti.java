...
public class RegionEntitiesMulti {
	...
	public static void setOwner(List<ProtectedRegion> regionListe, World world, LocalPlayer lPlayer) {
	...
	public static void addMember(List<ProtectedRegion> regionListe, World world, LocalPlayer lPlayer) {
		if (regionListe.size() <= 30) {
	...
	public static void removeMember(List<ProtectedRegion> regionListe, World world, LocalPlayer lPlayer) {
		if (regionListe.size() <= 30) {
	...
	public static void clearMember(List<ProtectedRegion> regionListe, World world) {
		if (regionListe.size() <= 30) {
